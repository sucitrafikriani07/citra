  ...
  <div class="content-wrapper">
    ...
    <?php
      if(isset($_POST['simpan'])){
        ...
        $sisi   =$_POST['sisi']; // menyimpan masukan nilai sisi persegi ke dalam variabel
        ...
        echo "Luas Persegi = <h3> $hasil cm2</h3> <br />";
        //menyimpan data ke dalam tabel persegi
        $sql = $koneksi->query("insert into persegi values('$id_persegi','$sisi','$hasil')");
      ...
      $querypilihpersegi = mysqli_query($koneksi, "SELECT * FROM persegi") or die(mysql_error()); //query menampilkan bangun_ruang: persegi
