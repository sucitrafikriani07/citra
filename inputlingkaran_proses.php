  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Menghitung Luas Lingkaran</h1>
          </div><!-- /.col -->
    ...
    <?php
      if(isset($_POST['simpan'])){
        ...
        $jari   =$_POST['jari']; // menyimpan masukan nilai jari-jari ke dalam variabel
        $phie    =3.14; // menyimpan nilai 3.14 ke dalam variabel
        ...
        $hasil = $phie*($jari*$jari);
        
        echo "Hasil hitung luas lingkaran adalah sebagai berikut:<br />";
        echo "Luas Lingkaran = Phie x jari x jari <br />";
        echo "Luas Lingkaran =[ $phie x $jari x $jari ]  <br />";
        echo "Luas Lingkaran = <h3> $hasil cm2</h3> <br />";
        //menyimpan data inputan kedalam tabel lingkaran
        $sql = $koneksi->query("insert into lingkaran values('$id_lingkaran','$jari','$hasil')");
          ...
          Rumus Luas Lingkaran    : Phi x Jari-Jari x Jari-Jari
                                    3.14 x '. $jari. ' x '. $jari. ' 
          Luas Lingkaran          : '.$phie*($jari*$jari));
          fclose($file);

          $querypilihlingkaran = mysqli_query($koneksi, "SELECT * FROM lingkaran") or die(mysql_error()); //query menampilkan bangun_ruang: lingkaran
