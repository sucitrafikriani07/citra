  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">PERSEGI</h1>
          </div><!-- /.col -->
    ...
    <section class="content">
              ...
              <br> <a href="inputpersegi.php" class="btn btn-info" style="margin-bottom: 5px; "><i class="fas fa-plus-circle"></i> Hitung Luas</a>
            ...
            <table class="table table-striped table-bordered datatable-select-inputs">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="text-align:center; vertical-align:middle;">Sisi</th>
                ...
                <?php
                    $no = 1;
                    // untuk menampilkan data yang ada pada tabel persegi
                    $sql = $koneksi->query("select * from persegi");
                    while ($data = $sql->fetch_assoc()) {
                    ?>
                        <tr>
                            <td style="text-align:center; vertical-align:middle;"><?php echo $no++; ?></td>
                            <td style="text-align:center; vertical-align:middle;"><?php echo $data['sisi']; ?></td>
